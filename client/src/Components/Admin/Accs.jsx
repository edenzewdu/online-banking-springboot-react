        ...
        <>
            ...
            <div className="shadow-md sm:rounded-lg bg-white h-[60vh]">
                ...
                <span className="relative w-full max-w-sm">
                    ...
                    className="w-full pl-10 pr-4 py-2 rounded-lg border border-gray-300 text-gray-900 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-300"
                    />
                </span>
                </div>
